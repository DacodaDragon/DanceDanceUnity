...
public class DDRPlayer : MonoBehaviour
{
    ...
    [SerializeField] private DDRColorScheme colorScheme;

    [Space(10f)]
    [SerializeField]
    private DDRRow m_rowLeft;
    [SerializeField] private DDRRow m_rowDown;
    [SerializeField] private DDRRow m_rowUp;
    [SerializeField] private DDRRow m_rowRight;
    ...
    public void Start()
    {
        m_currentSong = GameObject.Find("_MusicPlayer").GetComponent<DDRSong>();
    ...
    #region Hooking
    public void HookRow(DDRRow Row, ref KeyEvent keyEvent, ref KeyEvent KeyUpEvent)
    {
        Row.OnArrowHit += RecieveArrowHit;
        Row.SetSongReference(m_currentSong);
        keyEvent += Row.Hit;

        DDRHitmarker hitMarker = Row.GetComponent<DDRHitmarker>();
